<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	따라서 ifnull을 사용하고,  
	ifnull을 사용해도 오류가 날 수 있는데, 
				You can't specify target table 'test2' for update in FROM clause 
	이는 특정 타겟을 정해주면 해결된다.
...
<% 
		...
		while(rs.next()){
			// 수정사항 3. 1번째 value는 bid이므로 rs.getString(1)을 하면 안됨! 
			out.println(rs.getInt("bid")+". "+rs.getString(2)+"님: ["+rs.getString(3)+"]<br>");
